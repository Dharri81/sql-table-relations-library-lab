...
def select_series_title_with_most_human_characters
  ...
  JOIN characters ON character_books.character_id 
  WHERE characters.species = 'human' GROUP BY series.titles
...
def select_series_title_with_most_human_characters
   ...
   JOIN character_books ON character_books.book_id = books.id JOIN characters ON character_books.character_id = characters.id WHERE characters.species = 'human' 
